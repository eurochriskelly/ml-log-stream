...
function jsonToCsvLine(logEntry, type) {
  if (type === 'request') {
    ...
    return [
      ...
      logEntry.runTime,
      logEntry.compileTime,
      logEntry.ingestTime,
      logEntry.requests,
      logEntry.inMemoryListHits,
      logEntry.compressedTreeSize,
      logEntry.compressedTreeCacheHits,
      logEntry.compressedTreeCacheMisses,
      logEntry.dbLibraryModuleCacheHits,
      logEntry.dbLibraryModuleCacheMisses,
      logEntry.dbMainModuleSequenceCacheHits,
      logEntry.dbMainModuleSequenceCacheMisses,
      logEntry.dbProgramCacheHits,
      logEntry.dbProgramCacheMisses,
      logEntry.envProgramCacheHits,
      logEntry.envProgramCacheMisses,
      logEntry.filterHits,
      logEntry.filterMisses,
      logEntry.fsProgramCacheHits,
      logEntry.fsProgramCacheMisses,
      logEntry.inMemoryCompressedTreeHits,
      logEntry.inMemoryCompressedTreeMisses,
      logEntry.listSize,
      logEntry.listCacheHits,
      logEntry.listCacheMisses,
      logEntry.writeLocks,
      logEntry.expandedTreeCacheHits,
      logEntry.expandedTreeCacheMisses,
